                    ...
                    <div className="bg-[#0a0a0f]/80 backdrop-blur-2xl rounded-[32px] shadow-2xl p-8 border border-white/10 relative overflow-hidden group hover:border-neon-blue/40 transition-all duration-700">
                        ...
                        <div className="text-center mb-10">
                            <motion.div
                                ...
                                className="inline-block mb-6 p-4 rounded-2xl bg-gradient-to-br from-neon-blue/20 to-neon-purple/20 border border-neon-blue/20"
                            >
                                <Gamepad2 className="w-12 h-12 text-neon-blue drop-shadow-[0_0_10px_#00f0ff]" />
                            </motion.div>

                            <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase mb-3">
                        ...
                        <div className={`relative transition-all duration-500 overflow-hidden rounded-xl border ${!agreed ? 'opacity-20 pointer-events-none filter grayscale' : 'opacity-100 border-white/10 hover:border-neon-blue/50'}`}>
